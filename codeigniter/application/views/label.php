...
<html lang="ja">
	<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# website: http://ogp.me/ns/website#">
		...
		<?php if ($page <= 1): ?>
			<meta name="description" content="<?=$current_label['name']?>のレズ動画が<?=$total_count?>件ありますので、是非ご覧ください。" />
		<?php else: ?>
			<meta name="description" content="(<?=$page?>ページ目) <?=$current_label['name']?>のレズ動画が<?=$total_count?>件ありますので、是非ご覧ください。" />
		<?php endif; ?>
		<meta name="keywords" content="レズ動画,レズ動画セレクト" />
		<meta property="og:title" content="<?=$current_label['name']?>のレズ動画 | レズ動画セレクト" />
		<meta property="og:type" content="website" />
		<meta property="og:image" content="http://lezselect.com/images/apple-touch-icon.png" />
		<meta property="og:url" content="http://lezselect.com/label/<?=$current_label['id']?>" />
		<meta property="og:description" content="<?=$current_label['name']?>のレズ動画が<?=$total_count?>件ありますので、是非ご覧ください。" />
		<meta property="og:site_name" content="レズ動画セレクト" />
		<?php if ($page <= 1): ?>
			<link rel="canonical" href="http://lezselect.com/label/<?=$current_label['id']?>" />
		<?php else: ?>
			<link rel="canonical" href="http://lezselect.com/label/<?=$current_label['id']?>/<?=$page?>" />
		<?php endif; ?>
		<?php if ($page > 1): ?>
			<?php if ($page == 2): ?>
				<link rel="prev" href="http://lezselect.com/label/<?=$current_label['id']?>" />
			<?php else: ?>
				<link rel="prev" href="http://lezselect.com/label/<?=$current_label['id']?>/<?=$page-1?>" />
			<?php endif; ?>
		<?php endif; ?>
		<?php if ($page_next_flag): ?>
			<link rel="next" href="http://lezselect.com/label/<?=$current_label['id']?>/<?=$page+1?>" />
		<?php endif; ?>
		<?php if ($page <= 1): ?>
			<title><?=$current_label['name']?>のレズ動画 | レズ動画セレクト</title>
		<?php else: ?>
			<title><?=$current_label['name']?>のレズ動画 (<?=$page?>ページ目) | レズ動画セレクト</title>
		<?php endif; ?>
				...
				<section class="wrapper site-min-height">
					...
					<div class="row">
						<div class="col-lg-12 main-chart">
							...
							<div class="row">
								...
								<div class="col-xs-12">
									<ol class="breadcrumb">
										...
										<li itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
											<a href="/label/order" itemprop="url"><span itemprop="title">レーベルで探す</span></a>
										</li>
										<li itemscope itemtype="http://data-vocabulary.org/Breadcrumb" class="active">
											<span itemprop="title"><?=$current_label['name']?>のレズ動画 (<?=$total_count?>件)</span>
										</li>
									</ol>
								</div>
							...
							<h1><i class="fa fa-chevron-circle-right"></i> <?=$current_label['name']?>のレズ動画 (<?=$total_count?>件)</h1>
